...
import { uploadNote } from "@/actions/subject/upload-note";
import { deleteVideoLecture } from "@/actions/subject/delete-video-lecture";
import { deleteNote } from "@/actions/subject/delete-note";
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="flex flex-wrap items-center gap-2">
                      {selectedVideo.chapter && (
                        <Badge 
                          variant="outline" 
                          className="font-medium px-3 py-1 bg-indigo-50 text-indigo-700 border-indigo-200 hover:bg-indigo-100"
                        >
                          {selectedVideo.chapter}
                        </Badge>
                      )}
                      {selectedVideo.topic && (
                        <Badge 
                          variant="outline" 
                          className="font-medium px-3 py-1 bg-purple-50 text-purple-700 border-purple-200 hover:bg-purple-100"
                        >
                          {selectedVideo.topic}
                        </Badge>
                      )}
