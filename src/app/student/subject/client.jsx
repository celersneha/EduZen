...
export function SubjectClient({ subject, subjectID }) {
  ...
  const classroomId = searchParams.get('classroomId') || searchParams.get('subjectID');
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl relative z-10">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              {subject.syllabusDescription ||
                'Explore your subject content and test your knowledge'}
            </p>
        ...
        >
          {/* Show Syllabus Card */}
          <Card
            className="bg-white/95 backdrop-blur-sm shadow-lg border-0 rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 group cursor-pointer"
            ...
            <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <CardDescription className="text-blue-100">
                  {showSyllabus
                    ? 'Close syllabus view'
                    : 'Explore all chapters and topics'}
                </CardDescription>
              </div>
            </CardHeader>
          ...
          >
            ...
            <CardContent className="p-6">
              <p className="text-gray-600">
                Test your knowledge with personalized quizzes. Choose specific
                    ...
                    {selectedChapter ? (
                      <div className="space-y-4">
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs text-gray-500 mt-2">
                            AI will generate 10 questions {selectedTopic ? `for ${selectedTopic}` : 'covering the entire chapter'}
                          </p>
                        </div>
                      </div>
                    ) : (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-500">
                          Choose a chapter to see test preview
                        </p>
                      </div>
                    )}
                  </div>
